...
public class Paddle {
    ...
    public Paddle(int screenX, int screenY)  // In this function we pass the screen dimensions as the parameters written by Mahesh Paramati
    {

        length = screenX / 6;//setting the lenght and height of the paddle
        height = screenY / 11;
    ...
    public void update(long fps)   // this method is to update the paddle movement written by Kartheek Anumolu kxa152730
    {
